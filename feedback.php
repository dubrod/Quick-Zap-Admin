...
$page_class = "dynamic";
$page_var = "feedback";
$page = z::select('* FROM mgr_feedback');
$page_title = $page->records[0]->feedback_title;
$page_post = $page->records[0]->feedback_post;
...
<head>
	<meta charset="UTF-8" />
	<title>Feedback Page Editing</title>
...
<div id="sb-site">
	...
	<div class="data-row">
		<h1 class="data-title">Editing the Feedback Page</h1>
