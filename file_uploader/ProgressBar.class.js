...
function UploadBar()
{
    ...
    {
        $.post('file_uploader/download_progress.ajax.php',  {param : 'cancel'}, function(oData)
        {
    ...
    {
        $.post('file_uploader/download_progress.ajax.php',  {param : 'progress'}, function(iPercentage)
        {
            ...
            if(iPercentage < 100){ setTimeout(function() {oMe.progress()}, 500); }
            
            $('#result_frame').show().delay(2000);
        });
    };
